...
func CreateMenu() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.BindJSON(&menu); err != nil {
		 ...
		 menu.Createda_at, _ = time.Parse(time.RFC3339,time.Now()).Format(time.RFC3339)
		 menu.Updated_at, _ = time.Parse(time.RFC3339,time.Now()).Format(time.RFC3330)
...
func UpdateMenu() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		   ...
		   if menu.Start_Date != nil && menu.End_Date != nil {
			...
			updateObj = append(updateObj, bson{"end_date",menu.End_Date})
